...
def main():
    ...
    daily_news = "data/processed/daily_news_prices.csv"
    
    # Load model frame
    model_df = build_model_frame(prices, daily_news_path=daily_news)
    ...
    print(f"omega (scaled): {garch_res.omega}") # wait, fit_garch11_baseline scales by 100 internally, and returns unscaled or scaled?
    # Let's check:
