...
from src.modeling.dataset import aggregate_article_sentiment, build_model_frame
...
def test_aggregate_article_sentiment_builds_daily_features():
    df = pd.DataFrame(
        [
            {"trading_date": "2024-01-02", "sentiment_score": 0.8, "sentiment_label": "positive", "url": "url1"},
            {"trading_date": "2024-01-02", "sentiment_score": -0.4, "sentiment_label": "negative", "url": "url2"},
            {"trading_date": "2024-01-03", "sentiment_score": 0.0, "sentiment_label": "neutral", "url": "url3"},
        ]
    )
